/*! jQuery v3.2.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function(a, b) {
                ...
                return g !== n && 9 === g.nodeType && g.documentElement ?
                    ((n = g),
                        ...
                        (c.getElementsByTagName = ja(function(a) {
                            return (
                                a.appendChild(n.createComment("")), !a.getElementsByTagName("*").length
                            );
                        })),
    ...
    (r.event = {
        ...
        dispatch: function(a) {
            ...
            if (
                ((b.delegateTarget = this), !k.preDispatch || k.preDispatch.call(this, b) !== !1)
            ) {
    ...
    function Oa(a, b, c) {
        ...
        return (
            ...
            ((g = c.getPropertyValue(b) || c[b]),
                "" !== g || r.contains(a.ownerDocument, a) || (g = r.style(a, b)), !o.pixelMarginRight() &&
                Ma.test(g) &&
                La.test(b) &&
                ((d = h.width),
                    (e = h.minWidth),
            ...
            trigger: function(b, c, e, f) {
                ...
                if (
                    ...
                    if (!f && !n.noBubble && !r.isWindow(e)) {
                        for (
                            j = n.delegateType || p, sb.test(j + p) || (h = h.parentNode); h; h = h.parentNode
                        )
                            o.push(h), (i = h);
                        i === (e.ownerDocument || d) &&
        ...
        r.each(["get", "post"], function(a, b) {
            r[b] = function(a, c, d, e) {
                return (
                    ...
                    r.ajax(
                        r.extend({ url: a, type: b, dataType: e, data: c, success: d },
                            r.isPlainObject(a) && a
                        )
                    )
                );
    ...
    r.ajaxSetup({
        ...
        r.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" },
            function(a, b) {
                var c = "pageYOffset" === b;
                r.fn[a] = function(d) {
                    return T(
        ...
        r.each({ Height: "height", Width: "width" }, function(a, b) {
            r.each({ padding: "inner" + a, content: b, "": "outer" + a },
                function(c, d) {
                    r.fn[d] = function(e, f) {
